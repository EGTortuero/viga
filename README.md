...
* Python modules:
    ...
    - pyrodigal (Larralde, 2022; https://github.com/althonos/pyrodigal/): especially from 0.14.0 towards
    - pyrodigal-gv (Camargo et al. 2023; https://github.com/althonos/pyrodigal-gv): especially from 0.14.0 towards
